...
dump-catalog-fixtures:
	${MANAGE_UTF} dumpdata catalog.Categories catalog.Goods catalog.GoodsImage catalog.GoodsVideo catalog.GoodsCharacteristic --indent 2 --output fixtures/catalog.json
